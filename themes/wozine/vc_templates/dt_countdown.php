...
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Days','wozine').'</div>
	<div class="countdown-item-value">%D</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Hours','wozine').'</div>
	<div class="countdown-item-value">%H</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Minuts','wozine').'</div>
	<div class="countdown-item-value">%M</div>
</div>
<div class="countdown-item">
	<div class="countdown-item-label">'.__('Seconds','wozine').'</div>
